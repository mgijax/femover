...
# contains data definition information for the uni_by_symbol table
...
comments = {
        ...
        Table.COLUMN : {
                ...
                'by_symbol' : 'precomputed sequence number for sorting this expression result by marker symbol',
                },
        Table.INDEX : {},
        }
