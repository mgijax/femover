...
# contains data definition information for the uni_by_structure table
...
comments = {
	...
	Table.COLUMN : {
		...
		'by_structure' : 'precomputed sequence number for sorting this expression result by anatomical structure',
		},
	Table.INDEX : {},
	}
