...
# contains data definition information for the strain_mutation table
...
comments = {
	Table.TABLE : 'petal table for strain flower, containing mutated alleles and their markers for strains',
	Table.COLUMN : {
		'unique_key' : 'primary key for this table, no other purpose',
		'strain_key' : 'identifies the strain (FK to strain table)',
		'marker_key' : 'identifies the marker of the mutation (FK to marker table)',
		'marker_symbol' : 'marker symbol, cached for convenience',
		'marker_id' : 'primary ID of marker, cached for convenience',
		'allele_key' : 'identifies the allele of the mutation (FK to allele table)',
	...
	Table.INDEX : {
		'allele_key' : 'quickly find all strains for an allele',
		'marker_key' : 'quickly find all strains with mutations for a marker',
