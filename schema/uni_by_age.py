...
# contains data definition information for the uni_by_age table
...
comments = {
        ...
        Table.COLUMN : {
                ...
                'by_age' : 'precomputed sequence number for sorting this expression result by age',
                },
        Table.INDEX : {},
        }
