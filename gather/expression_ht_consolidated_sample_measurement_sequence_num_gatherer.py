...
# 
# Gathers a minimal set of data (1 row) for the 'expression_ht_consolidated_sample_measurement_sequence_num' table in the front-end database.
...
fieldOrder = [ '_RNASeqCombined_key', 'byGeneSymbol', 'byAge', 'byStructure', 'byExpressed', 'byExperiment' ]

filenamePrefix = 'expression_ht_consolidated_sample_measurement_sequence_num'
