...
cmds = [
        ...
        '''
        select distinct gg._Marker_key, gg._Allele_key, v._Term_key, v._AnnotType_key, 
                v._Object_key, t.term, a.accID, vv.name
        from VOC_Annot v, VOC_Term t, VOC_Vocab vv, 
                GXD_AlleleGenotype gg, ALL_Allele ag, ACC_Accession a
        ...
        select distinct v._Object_key, v._Term_key, v._AnnotType_key, 
                null::integer, null::integer, t.term, a.accID, vv.name
...
# output file
fieldOrder = [ Gatherer.AUTO, '_Marker_key', '_Allele_key', '_Term_key', '_AnnotType_key', '_Object_key', 'term', 'accID', 'name' ]
