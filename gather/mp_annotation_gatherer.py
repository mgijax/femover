...
class LabCache:
        ...
        def getMaxSequenceNum (self):
                mx = 0
                for lab in list(self.byName.values()):
...
class AnnotationGatherer (Gatherer.MultiFileGatherer):
        ...
        def buildDiseaseGenotypes(self):
                ...
                dGenotypeRows = []
                count = 0
                for allele_key,genotype_keys in list(self.diseaseGenotypeMap.items()):
        ...
        def getRegisteredCellCalls(self,allele_key,termID):
                ...
                pheno_genos = {}
                cell_seqs = []
                for gkey,statsMap in list(self.genotypeStatisticsMap[allele_key].items()):
                ...
                for item in list(pheno_genos.values()):
        ...
        def buildMPRows (self ):
                ...
                for sr_key,systemObj in list(systemDict.items()):
                        gkey = systemObj["gkey"]
                        ...
                        for term,termID,termKey,termSeq,evidenceKey,call,sex,jnum,source in terms:
                                ...
                                for (note, note_type) in self.getNotes(evidenceKey):
                                        ...
                                        if evidenceKey in normalEvidenceKeys:
                                                normal = 1
                                        else:
                                                normal = 0
        ...
        def buildPhenoTableRows(self):
                ...
                provider_count = 0
                pRows = []
                for allele_key,item in list(self.providerRowsDict.items()):
        ...
        def initDiseaseRows(self):
                ...
                disease_set.sort(key=symbolsort.splitter)
                count = 0
        ...
        def getSource (self, evidenceKey, jnum):
                ...
                if evidenceKey in self.phenotypingCenters:
                        pc = self.phenotypingCenters[evidenceKey]
                if evidenceKey in self.interpretationCenters:
