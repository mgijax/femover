...
class ExpressionImagePaneGatherer (Gatherer.MultiFileGatherer):
        ...
        def getAssays (self, resultIndex, label):
                ...
                for row in rows:
                        ...
                        self.registerImagePaneSortFields(row[paneKeyCol], assayTypeKey=row[assayTypeKeyCol],
                                markerSymbol=symbol, citation=row[citationCol], hybridization=hybridization)
        ...
        def sortImagePaneFields(self):
                ...
                sortedFields = []
                pstList = list(self.paneSeqTracker.items())
                pstList.sort()
                for paneKey,tracker in pstList:
