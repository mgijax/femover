...
class HeadingCollection:
        ...
        def getTermRows (self):
                headingKeys = list(self.terms.keys())
                headingKeys.sort()
...
class SlimgridGatherer (Gatherer.CachingMultiFileGatherer):
        ...
        def processMP (self):
                ...
                for markerKey in markerKeys:
                        for (termKey, headingKey) in mapping:
                                ...
                                if termKey in byMarker[markerKey]:
        ...
        def processGO (self):
                ...
                markerKeys = list(rowsByMarker.keys())
                markerKeys.sort()
                for markerKey in markerKeys:
                        byMarker[markerKey] = {}
                        headerTermKeys = list(rowsByMarker[markerKey].keys())
                        headerTermKeys.sort()
                        for headerTermKey in headerTermKeys:
        ...
        def processAnatomy (self):
                ...
                for markerKey in markerKeys:
                        for (termKey, headingKey) in mapping:
                            ...
                            if termKey in counts[markerKey]:
