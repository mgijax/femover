...
class AlleleGatherer (Gatherer.Gatherer):
        ...
        def collateResults (self):
                ...
                for key in list(self.inducible.keys()):
        ...
        def postprocessResults (self):
                ...
                for r in self.finalResults:
                        ...
                        if allele in self.genes:
                                gene = self.genes[allele]
                        else:
                                gene = None

                        if allele in self.inducible:
                                inducibleNote = self.inducible[allele]
                        else:
                                inducibleNote = None

                        if allele in self.molNote:
