...
class MarkerCountsGatherer (Gatherer.Gatherer):
        ...
        def collateResults (self):
                ...
                keyList = list(markerCounts.keys())
                keyList.sort()
                for markerKey in keyList:
                        alleleRows.append (
                ...
                keyList2 = list(miCounts.keys())
                keyList2.sort()
                for markerKey in keyList2:
