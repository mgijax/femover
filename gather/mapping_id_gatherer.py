...
def rowSortKey(a):
        # returns a key for sorting tuples with (experiment key, string id)
        # assumes EXPT_KEY_COL and ID_COL have been initialized
        return (a[EXPT_KEY_COL], symbolsort.splitter(a[ID_COL]))
