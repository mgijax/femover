...
# 
# gathers data for the 'uni_by_detected' table in the front-end database
...
class ByDetectedGatherer (Gatherer.ChunkGatherer):
	# Is: a data gatherer for the uni_by_detected table
...
filenamePrefix = 'uni_by_detected'

# global instance of a ByDetectedGatherer
gatherer = ByDetectedGatherer (filenamePrefix, fieldOrder, cmds)
