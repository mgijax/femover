...
def markerTupleSortKey(t):
        # return sort key for tuple (symbol, marker key)
        return symbolsort.splitter(t[0])
...
class GenotypeSequenceNumGatherer (Gatherer.Gatherer):
        ...
        def byAlleles(self, alleleSortVal):
                ...
                for row in rows:
                        ...
                        if allele1Key not in alleleSortVal:
                ...
                genotypeList.sort(key=lambda a : a[1])
        ...
        def byHDPRules(self, alleleSortVal):
                ...
                for o in orderedHDP:
                        genotypeKey = o[4]
                        if genotypeKey in genotypeList:
                                continue
        ...
        def collateResults (self):
                ...
                alleleList.sort (key=markerTupleSortKey)
