...
def getMPHeaderKey (headerTerm):
        ...
        if headerTerm in mpHeaderTermToKey:
...
def getMPHeaders (mpTermKey):
        ...
        if mpTermKey in mpTermKeyToHeaders:
...
def _initMPHeaders():
        ...
        for row in rows:
                ...
                if header not in mpHeaderTermToKey:
...
def getDiseaseHeaders (diseaseTermKey):
        ...
        if diseaseTermKey in diseaseTermKeyToHeaders:
