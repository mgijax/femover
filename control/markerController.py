...
# This script is responsible for keeping the object mapping for a marker.  
# It can be invoked in one of two ways, either by simply calling it
# which will in turn call all of the gather/populate scripts for a marker.
...
tables = [ 'marker', 'markerID', 'markerSynonym', 'markerOrthology',
	...
	'markerToSequence', 'markerSequenceNum', 'markerToAllele',
	]
