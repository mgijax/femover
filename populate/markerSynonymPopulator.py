...
# 
# markerSynonym table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import markerSynonym

###--- Classes ---###

class MarkerSynonymPopulator (Populator.Populator):
	# Is: a Populator for the 'markerSynonym' table in the MySQL database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerSynonym table
...
# global instance of a MarkerSynonymPopulator
populator = MarkerSynonymPopulator (markerSynonym.table)
