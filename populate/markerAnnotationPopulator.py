...
# 
# markerAnnotation table populator for the Mover suite.
...
class MarkerAnnotationPopulator (Populator.Populator):
	# Is: a Populator for the 'markerAnnotation' table in the MySQL
	#	database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerAnnotation table
...
# global instance of a MarkerAnnotationPopulator
populator = MarkerAnnotationPopulator (markerAnnotation.table)
