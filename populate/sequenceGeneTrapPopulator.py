...
# 
# sequenceGeneTrap table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import sequenceGeneTrap

###--- Classes ---###

class SequenceGeneTrapPopulator (Populator.Populator):
	# Is: a Populator for the 'sequenceGeneTrap' table in the MySQL db
	...
	def loadBySequenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the sequenceGeneTrap table
...
# global instance of a SequenceGeneTrapPopulator
populator = SequenceGeneTrapPopulator (sequenceGeneTrap.table)
