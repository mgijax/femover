...
# 
# referenceSequenceNum table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import referenceSequenceNum

###--- Classes ---###

class ReferenceSequenceNumPopulator (Populator.Populator):
	# Is: a Populator for the 'referenceSequenceNum' table in the MySQL
	#	database
	# Has: knowledge of how to refresh data for an individual 
	#	reference key
	...
	def loadByReferenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the referenceSequenceNum
		#	table associated with the given reference key
...
# global instance of a ReferenceSequenceNumPopulator
populator = ReferenceSequenceNumPopulator (referenceSequenceNum.table)
