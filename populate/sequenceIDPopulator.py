...
# 
# sequenceID table populator for the Mover suite.
...
class SequenceIDPopulator (Populator.Populator):
	# Is: a Populator for the 'sequenceID' table in the MySQL database
	...
	def loadBySequenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the sequenceID table
...
# global instance of a SequenceIDPopulator
populator = SequenceIDPopulator (sequenceID.table)
