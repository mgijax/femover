...
# 
# markerNote table populator for the Mover suite.
...
class MarkerNotePopulator (Populator.Populator):
	# Is: a Populator for the 'markerNote' table in the MySQL database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerNote table
...
# global instance of a MarkerNotePopulator
populator = MarkerNotePopulator (markerNote.table)
