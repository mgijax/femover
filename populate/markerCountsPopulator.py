...
# 
# markerCounts table populator for the Mover suite.
...
class MarkerCountsPopulator (Populator.Populator):
	# Is: a Populator for the 'markerCounts' table in the MySQL database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerCounts table
...
# global instance of a MarkerCountsPopulator
populator = MarkerCountsPopulator (markerCounts.table)
