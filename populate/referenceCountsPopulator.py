...
# 
# referenceCounts table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import referenceCounts

###--- Classes ---###

class ReferenceCountsPopulator (Populator.Populator):
	# Is: a Populator for the referenceCounts table in the MySQL database
	...
	def loadByReferenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the referenceCounts table
...
# global instance of a ReferenceCountsPopulator
populator = ReferenceCountsPopulator (referenceCounts.table)
