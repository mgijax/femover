...
# 
# sequenceSequenceNum table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import sequenceSequenceNum

###--- Classes ---###

class SequenceSequenceNumPopulator (Populator.Populator):
	# Is: a Populator for the 'sequenceSequenceNum' table in the MySQL
	#	database
	...
	def loadBySequenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the sequenceSequenceNum
		#	table associated with the given sequence key
...
# global instance of a SequenceSequenceNumPopulator
populator = SequenceSequenceNumPopulator (sequenceSequenceNum.table)
