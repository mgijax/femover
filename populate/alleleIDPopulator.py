...
# 
# alleleID table populator for the Mover suite.
...
class AlleleIDPopulator (Populator.Populator):
	# Is: a Populator for the 'alleleID' table in the MySQL database
	...
	def loadByAlleleKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the alleleID table associated
		#	with the given alleleKey
...
# global instance of a AlleleIDPopulator
populator = AlleleIDPopulator (alleleID.table)
