...
# 
# markerOrthology table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import markerOrthology

###--- Classes ---###

class MarkerOrthologyPopulator (Populator.Populator):
	# Is: a Populator for the 'markerOrthology' table in the MySQL
	#	database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerOrthology table
...
# global instance of a MarkerOrthologyPopulator
populator = MarkerOrthologyPopulator (markerOrthology.table)
