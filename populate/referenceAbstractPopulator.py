...
# 
# referenceAbstract table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import referenceAbstract

###--- Classes ---###

class ReferenceAbstractPopulator (Populator.Populator):
	# Is: a Populator for the 'referenceAbstract' table in the MySQL
	#	database
	...
	def loadByReferenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the referenceAbstract table
...
# global instance of a ReferenceAbstractPopulator
populator = ReferenceAbstractPopulator (referenceAbstract.table)
