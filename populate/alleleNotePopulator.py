...
# 
# alleleNote table populator for the Mover suite.
...
class AlleleNotePopulator (Populator.Populator):
	# Is: a Populator for the 'alleleNote' table in the MySQL database
	...
	def loadByAlleleKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the alleleNote table
...
# global instance of a AlleleNotePopulator
populator = AlleleNotePopulator (alleleNote.table)
