...
# 
# marker table populator for the Mover suite.
...
class MarkerPopulator (Populator.Populator):
	# Is: a Populator for the 'marker' table in the MySQL database
	...
	def loadByMarkerKey (self,
		...
		# Purpose: to refresh the data for the specified marker key
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the 'marker' table associated
		#	with the given marker key
...
# global instance of a MarkerPopulator
populator = MarkerPopulator (marker.table)
