...
# 
# sequenceLocation table populator for the Mover suite.
...
class SequenceLocationPopulator (Populator.Populator):
	# Is: a Populator for the 'sequenceLocation' table in the MySQL db
	...
	def loadBySequenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the sequenceLocation table
...
# global instance of a SequenceLocationPopulator
populator = SequenceLocationPopulator (sequenceLocation.table)
