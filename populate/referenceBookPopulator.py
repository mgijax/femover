...
# 
# referenceBook table populator for the Mover suite.

import sys
sys.path.insert (0, '../schema')

import Populator
import referenceBook

###--- Classes ---###

class ReferenceBookPopulator (Populator.Populator):
	# Is: a Populator for the 'referenceBook' table in the MySQL database
	...
	def loadByReferenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the referenceBook table
...
# global instance of a ReferenceBookPopulator
populator = ReferenceBookPopulator (referenceBook.table)
