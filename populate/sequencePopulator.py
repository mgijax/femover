...
# 
# sequence table populator for the Mover suite.
...
class SequencePopulator (Populator.Populator):
	# Is: a Populator for the 'sequence' table in the MySQL database
	...
	def loadBySequenceKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the sequence table associated
		#	with the given sequence key
...
# global instance of a SequencePopulator
populator = SequencePopulator (sequence.table)
