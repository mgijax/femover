...
# 
# markerLocation table populator for the Mover suite.
...
class MarkerLocationPopulator (Populator.Populator):
	# Is: a Populator for the 'markerLocation' table in the MySQL database
	...
	def loadByMarkerKey (self,
		...
		# Returns: nothing
		# Assumes: nothing
		# Modifies: updates the data in the markerLocation table
...
# global instance of a MarkerLocationPopulator
populator = MarkerLocationPopulator (markerLocation.table)
